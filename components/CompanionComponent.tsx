...
const CompanionComponent: React.FC<CompanionComponentProps> = ({ companionId, subject, topic, name, userName, userImage, style, voice }) => {
    ...
    const handleCall = async () => {
        ...
        // @ts-expect-error: a possible typeScript error since assistantOverrides is an object
